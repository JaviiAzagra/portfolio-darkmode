      ...
      <div className="container">
        ...
        <div>
          <div className="container--text">
            ...
            <p className="site">
              <strong>Upgrade Hub, Madrid</strong>
            </p>
          ...
          <div className="container--text">
            ...
            <p className="site">
              <strong>Universidad Complutense, Madrid</strong>
            </p>
          ...
          <div className="container--text">
            <p className="name">
              🔲 Grado Superior en Administración de Sistemas Informáticos en
              Red
            </p>
            <p className="site">
              <strong>Universidad Complutense, Madrid</strong>
          ...
          <div className="container--text">
            ...
            <p className="site">
              <strong>Colegio Santa Helena, Alcobendas, Madrid</strong>
            </p>
            <p>2016 - 2019</p>
          </div>
        </div>
      ...
      <div className="container">
        ...
        <div>
          <div className="container--text">
            ...
            <p className="site">
              <strong>Primavera Sound, Madrid</strong>
            </p>
